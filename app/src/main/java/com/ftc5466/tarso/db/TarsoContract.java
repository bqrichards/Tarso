...
public final class TarsoContract {
    ...
    public static class TeamEntry implements BaseColumns {
        ...
        public static final String COLUMN_NAME_TELEOP_GLYPH_STRATEGY = "teleopglyphstrategy";
        ...
        public static final String COLUMN_NAME_ENDGAME_RELIC_ZONE = "endgamereliczone";
